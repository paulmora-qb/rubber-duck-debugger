...
#   com.rdd.weekly-strategy          — every Friday 12:00 local  (ai_fundamental_screen_weekly)
#   com.rdd.weekly-news-analysis     — every Friday 12:00 local  (news analysis reports)
#   com.rdd.monthly-strategy         — 1st of each month 12:00 local  (ai_fundamental_screen_monthly)
...
# ── 2. Weekly performance email — Friday 12:00 ───────────────────────────────
...
# ── 3. Weekly strategy — Friday 12:00 ────────────────────────────────────────

install_agent "com.rdd.weekly-strategy" "$SCRIPT_DIR/run_weekly_strategy.sh" \
"<?xml version=\"1.0\" encoding=\"UTF-8\"?>
<!DOCTYPE plist PUBLIC \"-//Apple//DTD PLIST 1.0//EN\" \"http://www.apple.com/DTDs/PropertyList-1.0.dtd\">
<plist version=\"1.0\">
<dict>
    <key>Label</key><string>com.rdd.weekly-strategy</string>
    <key>ProgramArguments</key>
    <array>
        <string>/bin/bash</string>
        <string>$SCRIPT_DIR/run_weekly_strategy.sh</string>
    </array>
    <!-- Every Friday at 12:00 local -->
    <key>StartCalendarInterval</key>
    <dict>
    ...
    <key>StandardOutPath</key><string>$LOG_DIR/weekly_strategy.log</string>
    <key>StandardErrorPath</key><string>$LOG_DIR/weekly_strategy.log</string>
</dict>
</plist>"

# ── 4. Weekly news analysis — Friday 12:00 ───────────────────────────────────
...
echo "  Weekly strategy          → every Friday 12:00 local"

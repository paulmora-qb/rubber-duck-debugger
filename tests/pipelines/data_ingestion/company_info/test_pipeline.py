...
from rdd.pipelines.data_ingestion.company_info.pipeline import create_pipeline
...
def test_pipeline_runs_successfully(mocker, pipeline, in_memory_catalog) -> None:
    ...
    mocker.patch(
        "rdd.pipelines.data_ingestion.company_info.nodes.yf.Ticker",
...
def test_pipeline_skips_fresh_snapshots(
    ...
    yf_spy = mocker.patch("rdd.pipelines.data_ingestion.company_info.nodes.yf.Ticker")
